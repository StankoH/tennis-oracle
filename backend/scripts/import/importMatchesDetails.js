  ...
  try {
    ...
    for await (const data of readStream) {
      ...
      const match = {
        ...
        player1TrueSkillMeanM: toNumber(data.player1TrueSkillMeanM),
        player1TrueSkillStandardDeviationM: toNumber(data.player1TrueSkillStandardDeviationM),
        player2TrueSkillMeanM: toNumber(data.player2TrueSkillMeanM),
        player2TrueSkillStandardDeviationM: toNumber(data.player2TrueSkillStandardDeviationM),
        ...
        player1TrueSkillMeanSM: toNumber(data.player1TrueSkillMeanSM),
        player1TrueSkillStandardDeviationSM: toNumber(data.player1TrueSkillStandardDeviationSM),
        player2TrueSkillMeanSM: toNumber(data.player2TrueSkillMeanSM),
        player2TrueSkillStandardDeviationSM: toNumber(data.player2TrueSkillStandardDeviationSM),
        ...
        player1TrueSkillMeanGSM: toNumber(data.player1TrueSkillMeanGSM),
        player1TrueSkillStandardDeviationGSM: toNumber(data.player1TrueSkillStandardDeviationGSM),
        player2TrueSkillMeanGSM: toNumber(data.player2TrueSkillMeanGSM),
        player2TrueSkillStandardDeviationGSM: toNumber(data.player2TrueSkillStandardDeviationGSM),
        ...
        player1TrueSkillMeanMS1: toNumber(data.player1TrueSkillMeanMS1),
        player1TrueSkillStandardDeviationMS1: toNumber(data.player1TrueSkillStandardDeviationMS1),
        player2TrueSkillMeanMS1: toNumber(data.player2TrueSkillMeanMS1),
        player2TrueSkillStandardDeviationMS1: toNumber(data.player2TrueSkillStandardDeviationMS1),
        ...
        player1TrueSkillMeanSMS1: toNumber(data.player1TrueSkillMeanSMS1),
        player1TrueSkillStandardDeviationSMS1: toNumber(data.player1TrueSkillStandardDeviationSMS1),
        player2TrueSkillMeanSMS1: toNumber(data.player2TrueSkillMeanSMS1),
        player2TrueSkillStandardDeviationSMS1: toNumber(data.player2TrueSkillStandardDeviationSMS1),
        ...
        player1TrueSkillMeanGSMS1: toNumber(data.player1TrueSkillMeanGSMS1),
        player1TrueSkillStandardDeviationGSMS1: toNumber(data.player1TrueSkillStandardDeviationGSMS1),
        player2TrueSkillMeanGSMS1: toNumber(data.player2TrueSkillMeanGSMS1),
        player2TrueSkillStandardDeviationGSMS1: toNumber(data.player2TrueSkillStandardDeviationGSMS1),
        ...
        player1TrueSkillMeanMS2: toNumber(data.player1TrueSkillMeanMS2),
        player1TrueSkillStandardDeviationMS2: toNumber(data.player1TrueSkillStandardDeviationMS2),
        player2TrueSkillMeanMS2: toNumber(data.player2TrueSkillMeanMS2),
        player2TrueSkillStandardDeviationMS2: toNumber(data.player2TrueSkillStandardDeviationMS2),
        ...
        player1TrueSkillMeanSMS2: toNumber(data.player1TrueSkillMeanSMS2),
        player1TrueSkillStandardDeviationSMS2: toNumber(data.player1TrueSkillStandardDeviationSMS2),
        player2TrueSkillMeanSMS2: toNumber(data.player2TrueSkillMeanSMS2),
        player2TrueSkillStandardDeviationSMS2: toNumber(data.player2TrueSkillStandardDeviationSMS2),
        ...
        player1TrueSkillMeanGSMS2: toNumber(data.player1TrueSkillMeanGSMS2),
        player1TrueSkillStandardDeviationGSMS2: toNumber(data.player1TrueSkillStandardDeviationGSMS2),
        player2TrueSkillMeanGSMS2: toNumber(data.player2TrueSkillMeanGSMS2),
        player2TrueSkillStandardDeviationGSMS2: toNumber(data.player2TrueSkillStandardDeviationGSMS2),
        ...
        player1TrueSkillMeanMS3: toNumber(data.player1TrueSkillMeanMS3),
        player1TrueSkillStandardDeviationMS3: toNumber(data.player1TrueSkillStandardDeviationMS3),
        player2TrueSkillMeanMS3: toNumber(data.player2TrueSkillMeanMS3),
        player2TrueSkillStandardDeviationMS3: toNumber(data.player2TrueSkillStandardDeviationMS3),
        ...
        player1TrueSkillMeanSMS3: toNumber(data.player1TrueSkillMeanSMS3),
        player1TrueSkillStandardDeviationSMS3: toNumber(data.player1TrueSkillStandardDeviationSMS3),
        player2TrueSkillMeanSMS3: toNumber(data.player2TrueSkillMeanSMS3),
        player2TrueSkillStandardDeviationSMS3: toNumber(data.player2TrueSkillStandardDeviationSMS3),
        ...
        player1TrueSkillMeanGSMS3: toNumber(data.player1TrueSkillMeanGSMS3),
        player1TrueSkillStandardDeviationGSMS3: toNumber(data.player1TrueSkillStandardDeviationGSMS3),
        player2TrueSkillMeanGSMS3: toNumber(data.player2TrueSkillMeanGSMS3),
        player2TrueSkillStandardDeviationGSMS3: toNumber(data.player2TrueSkillStandardDeviationGSMS3),
        ...
        player1TrueSkillMeanMS4: toNumber(data.player1TrueSkillMeanMS4),
        player1TrueSkillStandardDeviationMS4: toNumber(data.player1TrueSkillStandardDeviationMS4),
        player2TrueSkillMeanMS4: toNumber(data.player2TrueSkillMeanMS4),
        player2TrueSkillStandardDeviationMS4: toNumber(data.player2TrueSkillStandardDeviationMS4),
        ...
        player1TrueSkillMeanSMS4: toNumber(data.player1TrueSkillMeanSMS4),
        player1TrueSkillStandardDeviationSMS4: toNumber(data.player1TrueSkillStandardDeviationSMS4),
        player2TrueSkillMeanSMS4: toNumber(data.player2TrueSkillMeanSMS4),
        player2TrueSkillStandardDeviationSMS4: toNumber(data.player2TrueSkillStandardDeviationSMS4),
        ...
        player1TrueSkillMeanGSMS4: toNumber(data.player1TrueSkillMeanGSMS4),
        player1TrueSkillStandardDeviationGSMS4: toNumber(data.player1TrueSkillStandardDeviationGSMS4),
        player2TrueSkillMeanGSMS4: toNumber(data.player2TrueSkillMeanGSMS4),
        player2TrueSkillStandardDeviationGSMS4: toNumber(data.player2TrueSkillStandardDeviationGSMS4),
        ...
        player1H2HTrueSkillMeanM: toNumber(data.player1H2HTrueSkillMeanM),
        player1H2HTrueSkillStandardDeviationM: toNumber(data.player1H2HTrueSkillStandardDeviationM),
        player2H2HTrueSkillMeanM: toNumber(data.player2H2HTrueSkillMeanM),
        player2H2HTrueSkillStandardDeviationM: toNumber(data.player2H2HTrueSkillStandardDeviationM),
        ...
        player1H2HTrueSkillMeanSM: toNumber(data.player1H2HTrueSkillMeanSM),
        player1H2HTrueSkillStandardDeviationSM: toNumber(data.player1H2HTrueSkillStandardDeviationSM),
        player2H2HTrueSkillMeanSM: toNumber(data.player2H2HTrueSkillMeanSM),
        player2H2HTrueSkillStandardDeviationSM: toNumber(data.player2H2HTrueSkillStandardDeviationSM),
        ...
        player1H2HTrueSkillMeanGSM: toNumber(data.player1H2HTrueSkillMeanGSM),
        player1H2HTrueSkillStandardDeviationGSM: toNumber(data.player1H2HTrueSkillStandardDeviationGSM),
        player2H2HTrueSkillMeanGSM: toNumber(data.player2H2HTrueSkillMeanGSM),
        player2H2HTrueSkillStandardDeviationGSM: toNumber(data.player2H2HTrueSkillStandardDeviationGSM),
        ...
        player1H2HTrueSkillMeanMS1: toNumber(data.player1H2HTrueSkillMeanMS1),
        player1H2HTrueSkillStandardDeviationMS1: toNumber(data.player1H2HTrueSkillStandardDeviationMS1),
        player2H2HTrueSkillMeanMS1: toNumber(data.player2H2HTrueSkillMeanMS1),
        player2H2HTrueSkillStandardDeviationMS1: toNumber(data.player2H2HTrueSkillStandardDeviationMS1),
        ...
        player1H2HTrueSkillMeanSMS1: toNumber(data.player1H2HTrueSkillMeanSMS1),
        player1H2HTrueSkillStandardDeviationSMS1: toNumber(data.player1H2HTrueSkillStandardDeviationSMS1),
        player2H2HTrueSkillMeanSMS1: toNumber(data.player2H2HTrueSkillMeanSMS1),
        player2H2HTrueSkillStandardDeviationSMS1: toNumber(data.player2H2HTrueSkillStandardDeviationSMS1),
        ...
        player1H2HTrueSkillMeanGSMS1: toNumber(data.player1H2HTrueSkillMeanGSMS1),
        player1H2HTrueSkillStandardDeviationGSMS1: toNumber(data.player1H2HTrueSkillStandardDeviationGSMS1),
        player2H2HTrueSkillMeanGSMS1: toNumber(data.player2H2HTrueSkillMeanGSMS1),
        player2H2HTrueSkillStandardDeviationGSMS1: toNumber(data.player2H2HTrueSkillStandardDeviationGSMS1),
        ...
        player1H2HTrueSkillMeanMS2: toNumber(data.player1H2HTrueSkillMeanMS2),
        player1H2HTrueSkillStandardDeviationMS2: toNumber(data.player1H2HTrueSkillStandardDeviationMS2),
        player2H2HTrueSkillMeanMS2: toNumber(data.player2H2HTrueSkillMeanMS2),
        player2H2HTrueSkillStandardDeviationMS2: toNumber(data.player2H2HTrueSkillStandardDeviationMS2),
        ...
        player1H2HTrueSkillMeanSMS2: toNumber(data.player1H2HTrueSkillMeanSMS2),
        player1H2HTrueSkillStandardDeviationSMS2: toNumber(data.player1H2HTrueSkillStandardDeviationSMS2),
        player2H2HTrueSkillMeanSMS2: toNumber(data.player2H2HTrueSkillMeanSMS2),
        player2H2HTrueSkillStandardDeviationSMS2: toNumber(data.player2H2HTrueSkillStandardDeviationSMS2),
        ...
        player1H2HTrueSkillMeanGSMS2: toNumber(data.player1H2HTrueSkillMeanGSMS2),
        player1H2HTrueSkillStandardDeviationGSMS2: toNumber(data.player1H2HTrueSkillStandardDeviationGSMS2),
        player2H2HTrueSkillMeanGSMS2: toNumber(data.player2H2HTrueSkillMeanGSMS2),
        player2H2HTrueSkillStandardDeviationGSMS2: toNumber(data.player2H2HTrueSkillStandardDeviationGSMS2),
        ...
        player1H2HTrueSkillMeanMS3: toNumber(data.player1H2HTrueSkillMeanMS3),
        player1H2HTrueSkillStandardDeviationMS3: toNumber(data.player1H2HTrueSkillStandardDeviationMS3),
        player2H2HTrueSkillMeanMS3: toNumber(data.player2H2HTrueSkillMeanMS3),
        player2H2HTrueSkillStandardDeviationMS3: toNumber(data.player2H2HTrueSkillStandardDeviationMS3),
        ...
        player1H2HTrueSkillMeanSMS3: toNumber(data.player1H2HTrueSkillMeanSMS3),
        player1H2HTrueSkillStandardDeviationSMS3: toNumber(data.player1H2HTrueSkillStandardDeviationSMS3),
        player2H2HTrueSkillMeanSMS3: toNumber(data.player2H2HTrueSkillMeanSMS3),
        player2H2HTrueSkillStandardDeviationSMS3: toNumber(data.player2H2HTrueSkillStandardDeviationSMS3),
        ...
        player1H2HTrueSkillMeanGSMS3: toNumber(data.player1H2HTrueSkillMeanGSMS3),
        player1H2HTrueSkillStandardDeviationGSMS3: toNumber(data.player1H2HTrueSkillStandardDeviationGSMS3),
        player2H2HTrueSkillMeanGSMS3: toNumber(data.player2H2HTrueSkillMeanGSMS3),
        player2H2HTrueSkillStandardDeviationGSMS3: toNumber(data.player2H2HTrueSkillStandardDeviationGSMS3),
        ...
        player1H2HTrueSkillMeanMS4: toNumber(data.player1H2HTrueSkillMeanMS4),
        player1H2HTrueSkillStandardDeviationMS4: toNumber(data.player1H2HTrueSkillStandardDeviationMS4),
        player2H2HTrueSkillMeanMS4: toNumber(data.player2H2HTrueSkillMeanMS4),
        player2H2HTrueSkillStandardDeviationMS4: toNumber(data.player2H2HTrueSkillStandardDeviationMS4),
        ...
        player1H2HTrueSkillMeanSMS4: toNumber(data.player1H2HTrueSkillMeanSMS4),
        player1H2HTrueSkillStandardDeviationSMS4: toNumber(data.player1H2HTrueSkillStandardDeviationSMS4),
        player2H2HTrueSkillMeanSMS4: toNumber(data.player2H2HTrueSkillMeanSMS4),
        player2H2HTrueSkillStandardDeviationSMS4: toNumber(data.player2H2HTrueSkillStandardDeviationSMS4),
        ...
        player1H2HTrueSkillMeanGSMS4: toNumber(data.player1H2HTrueSkillMeanGSMS4),
        player1H2HTrueSkillStandardDeviationGSMS4: toNumber(data.player1H2HTrueSkillStandardDeviationGSMS4),
        player2H2HTrueSkillMeanGSMS4: toNumber(data.player2H2HTrueSkillMeanGSMS4),
        player2H2HTrueSkillStandardDeviationGSMS4: toNumber(data.player2H2HTrueSkillStandardDeviationGSMS4),
